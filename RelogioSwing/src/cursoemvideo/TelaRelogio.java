...
public class TelaRelogio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblHora.setForeground(new java.awt.Color(255, 153, 153));
        lblHora.setText("Clique no Botão!");

        btnHora.setFont(new java.awt.Font("Segoe UI Black", 0, 14)); // NOI18N
        btnHora.setForeground(new java.awt.Color(153, 0, 153));
